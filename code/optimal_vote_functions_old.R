...
# OK, what Andy does is he sums the utilities for each vote / piv. event event first, such that we end up with a reduced matrix. This is much more efficient. He is also more flexible in that his function allows for more generalisable functions. 
# I wonder if I can improve on this by vectorising
